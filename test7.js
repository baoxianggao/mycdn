(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.advertisement = factory(global.require$$1$1, global.require$$2, global.require$$0$2, global.require$$3, global.require$$4, global.require$$0$1, global.require$$1, global.require$$0, global.require$$8));
	...
	var utils$7 = utils$e;
	var cookies = utils$7.isStandardBrowserEnv() ? // Standard browser envs support document.cookie
	function standardBrowserEnv() {
	  return {
	    write: function write(name, value, expires, path, domain, secure) {
	      ...
	      if (utils$7.isNumber(expires)) {
	        cookie.push('expires=' + new Date(expires).toGMTString());
	      }

	      if (utils$7.isString(path)) {
	        cookie.push('path=' + path);
	      }

	      if (utils$7.isString(domain)) {
	...
	var hasFlag$1 = function hasFlag(flag, argv) {
	...
	var Writable = require$$4__default['default'].Writable;
	var debug = src.exports("follow-redirects"); // RFC7231§4.2.1: Of the request methods defined by this specification,
